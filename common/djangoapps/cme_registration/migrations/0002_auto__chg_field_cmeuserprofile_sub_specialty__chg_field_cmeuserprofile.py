...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'CmeUserProfile.sub_specialty'
        db.alter_column('cme_registration', 'sub_specialty', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

        # Changing field 'CmeUserProfile.how_stanford_affiliated'
        db.alter_column('cme_registration', 'how_stanford_affiliated', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

        # Changing field 'CmeUserProfile.specialty'
        db.alter_column('cme_registration', 'specialty', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

        # Changing field 'CmeUserProfile.hear_about_us'
        db.alter_column('cme_registration', 'hear_about_us', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

    def backwards(self, orm):

        # Changing field 'CmeUserProfile.sub_specialty'
        db.alter_column('cme_registration', 'sub_specialty', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

        # Changing field 'CmeUserProfile.how_stanford_affiliated'
        db.alter_column('cme_registration', 'how_stanford_affiliated', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

        # Changing field 'CmeUserProfile.specialty'
        db.alter_column('cme_registration', 'specialty', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

        # Changing field 'CmeUserProfile.hear_about_us'
        db.alter_column('cme_registration', 'hear_about_us', self.gf('django.db.models.fields.CharField')(max_length=25, null=True))
