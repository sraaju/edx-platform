...
#         self.course = CourseFactory.create()
    ...
    def test_stanford_affiliated_required(self):
        ...
        url = reverse('cme_create_account')
        response = self.client.post(url, {'username': 'testuser', 'email': 'test@email.com', 'password': '1234', 'name': 'Chester Tester'})
    ...
    def test_honour_code_required(self):
        ...
        url = reverse('cme_create_account')
        response = self.client.post(url, {'username': 'testuser', 'email': 'test@email.com', 'password': '1234', 'name': 'Chester Tester', 'stanford_affiliated': '1'})
    ...
    def test_profession_required(self):
        ...
        url = reverse('cme_create_account')
        response = self.client.post(url, {'username': 'testuser', 'email': 'test@email.com', 'password': '1234', 'name': 'Chester Tester', 'stanford_affiliated': '1', 'honor_code': 'true',
                                          'terms_of_service': 'true', 'profession': ''})
    ...
    def test_license_number_required(self):
        ...
        url = reverse('cme_create_account')
        response = self.client.post(url, {'username': 'testuser', 'email': 'test@email.com', 'password': '1234', 'name': 'Chester Tester', 'stanford_affiliated': '1', 'honor_code': 'true',
                                          'terms_of_service': 'true', 'profession': 'ZZ', 'license_number': ''})
    ...
    def test_patient_population_required(self):
        ...
        url = reverse('cme_create_account')
        response = self.client.post(url, {'username': 'testuser', 'email': 'test@email.com', 'password': '1234', 'name': 'Chester Tester', 'stanford_affiliated': '1', 'honor_code': 'true',
                                          'terms_of_service': 'true', 'profession': 'ZZ', 'license_number': '123', 'patient_population': ''})
    ...
    def test_specialty_required(self):
        ...
        url = reverse('cme_create_account')
        response = self.client.post(url, {'username': 'testuser', 'email': 'test@email.com', 'password': '1234', 'name': 'Chester Tester', 'stanford_affiliated': '1', 'honor_code': 'true',
                                          'terms_of_service': 'true', 'profession': 'AA', 'license_number': '123', 'patient_population': 'BB', 'specialty': ''})
    ...
    def test_sub_specialty_not_required(self):
        ...
        url = reverse('cme_create_account')
        response = self.client.post(url, {'username': 'testuser', 'email': 'test@email.com', 'password': '1234', 'name': 'Chester Tester', 'stanford_affiliated': '1', 'honor_code': 'true',
                                          'terms_of_service': 'true', 'profession': 'AA', 'license_number': '123', 'patient_population': 'BB', 'specialty': 'CC', 'address_1': ''})
    ...
    def test_address_1_required(self):
        ...
        url = reverse('cme_create_account')
        response = self.client.post(url, {'username': 'testuser', 'email': 'test@email.com', 'password': '1234', 'name': 'Chester Tester', 'stanford_affiliated': '1', 'honor_code': 'true',
                                          'terms_of_service': 'true', 'profession': 'AA', 'license_number': '123', 'patient_population': 'BB', 'specialty': 'CC', 'sub_specialty': 'DD', 'address_1': ''})
        self.assertContains(response, '{"field": "address_1", "value": "Enter your Address 01", "success": false}')
    ...
    def test_city_required(self):
        ...
        url = reverse('cme_create_account')
        response = self.client.post(url, {'username': 'testuser', 'email': 'test@email.com', 'password': '1234', 'name': 'Chester Tester', 'stanford_affiliated': '1', 'honor_code': 'true',
                                          'terms_of_service': 'true', 'profession': 'AA', 'license_number': '123', 'patient_population': 'BB', 'specialty': 'CC', 'sub_specialty': 'DD', 
                                          'address_1': 'EE', 'city': ''})
    ...
    def test_state_province_required(self):
        ...
        response = self.client.post(url, {'username': 'testuser', 'email': 'test@email.com', 'password': '1234', 'name': 'Chester Tester', 'stanford_affiliated': '1', 'honor_code': 'true',
                                          'terms_of_service': 'true', 'profession': 'AA', 'license_number': '123', 'patient_population': 'BB', 'specialty': 'CC', 'sub_specialty': 'DD', 
                                          'address_1': 'EE', 'city': 'FF', 'state_province': ''})
    ...
    def test_postal_code_required(self):
        ...
        response = self.client.post(url, {'username': 'testuser', 'email': 'test@email.com', 'password': '1234', 'name': 'Chester Tester', 'stanford_affiliated': '1', 'honor_code': 'true',
                                          'terms_of_service': 'true', 'profession': 'AA', 'license_number': '123', 'patient_population': 'BB', 'specialty': 'CC', 'sub_specialty': 'DD', 
                                          'address_1': 'EE', 'city': 'FF', 'state_province': 'GG', 'postal_code': ''})
        print response
    ...
    def test_country_required(self):
        ...
        response = self.client.post(url, {'username': 'testuser', 'email': 'test@email.com', 'password': '1234', 'name': 'Chester Tester', 'stanford_affiliated': '1', 'honor_code': 'true',
                                          'terms_of_service': 'true', 'profession': 'AA', 'license_number': '123', 'patient_population': 'BB', 'specialty': 'CC', 'sub_specialty': 'DD', 
                                          'address_1': 'EE', 'city': 'FF', 'state_province': 'GG', 'postal_code': 'HH', 'country': ''})
    ...
    def test_phone_number_required(self):
        ...
        response = self.client.post(url, {'username': 'testuser', 'email': 'test@email.com', 'password': '1234', 'name': 'Chester Tester', 'stanford_affiliated': '1', 'honor_code': 'true',
                                          'terms_of_service': 'true', 'profession': 'AA', 'license_number': '123', 'patient_population': 'BB', 'specialty': 'CC', 'sub_specialty': 'DD', 
                                          'address_1': 'EE', 'city': 'FF', 'state_province': 'GG', 'postal_code': 'HH', 'country': 'II', 'phone_number': ''})
    ...
    def test_hear_about_us_required(self):
        ...
        response = self.client.post(url, {'username': 'testuser', 'email': 'test@email.com', 'password': '1234', 'name': 'Chester Tester', 'stanford_affiliated': '1', 'honor_code': 'true',
                                          'terms_of_service': 'true', 'profession': 'AA', 'license_number': '123', 'patient_population': 'BB', 'specialty': 'CC', 'sub_specialty': 'DD', 
                                          'address_1': 'EE', 'city': 'FF', 'state_province': 'GG', 'postal_code': 'HH', 'country': 'II', 'phone_number': 'JJ', 'hear_about_us': ''})
