...
class VideoAlphaModuleTest(LogicTest):
    ...
    def test_create_youtube_string(self):
        ...
        self.assertEqual(descriptor._create_youtube_string(), expected)

    def test_create_youtube_string_missing(self):
        """
        Test that Youtube IDs which aren't explicitly set aren't included in the output XML.
        """
        system = DummySystem(load_error_modules=True)
        location = Location(["i4x", "edX", "videoalpha", "default","SampleProblem1"])
        model_data = {'location': location}
...
class VideoAlphaExportTestCase(unittest.TestCase):
    ...
    correctly, in the event that it is asked to do so.
    """
    ...
    def test_export_to_xml(self):
        ...
        expected = dedent('''\
         <videoalpha start_time="1.0" youtube="0.75:izygArpw-Qo,1.00:p2Q6BrNhdh8,1.25:1EeWXzPdhSA,1.50:rABDYkeK0x8" show_captions="false" end_time="60">
           <source src="http://www.example.com/source.mp4"/>
           <source src="http://www.example.com/source.ogg"/>
           <track src="http://www.example.com/track"/>
         </videoalpha>
    ...
    def test_export_to_xml_empty_parameters(self):
        ...
        expected = '<videoalpha youtube="1.00:OEoXaMPEzfM" show_captions="true"/>\n'
